...
def run():
    ...
    # Serialized data - serialized as a tuple.
    ## {results, setName}
    # Fetch list of all set_identifiers for each sport.
    # Take dumps and convert to checklist_object.
    # Serialize and save checklist_objects to dumps/checklist_objects/catgory_identifier

    category_identifiers = ["football-cards"]
